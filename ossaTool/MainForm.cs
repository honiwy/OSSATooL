...
namespace ossaTool
{
    public partial class MainForm : Form
    {
        ...
        private String adbPath = Path.Combine(Path.GetPathRoot(Application.StartupPath), "OSSA_new\\ossalTool\\adb\\adb.exe");
        //@"D:\OSSA_new\ossaTool\flash_images_and_validate.bat";
        private String qfilPath = Path.Combine(Path.GetPathRoot(Application.StartupPath), "OSSA_new\\ossalTool\\flash_images_and_validate.bat");
        ...
        private void connectionProcess(DoWorkEventArgs e, bool edlProcess)
        {
            ...
            psi.FileName = Path.GetFileName(adbPath);
        ...
        private void qFILProcess()
        {
            ...
            p.StartInfo.FileName = @"D:\OSSA_new\ossaTool\flash_images_and_validate.bat"; 
